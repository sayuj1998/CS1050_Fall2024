...
public class TestPassArrays {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\tWhat is stored on the stack what is stored on the heap?");
        // The primitive data is on the stack, arrays are on the heap
        ...
        // Arrays have the same memory path if arrays are declared into other arrays.
