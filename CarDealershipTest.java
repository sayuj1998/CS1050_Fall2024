...
public class CarDealershipTest
{
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            Car car1 = new Car("Ford","Mustang", 32800.00);
            Car car2 = new Car("Nissan","Altima", 14500.00);
            Car car3 = new Car("Dodge","Dart", 19900.00);
            Car car4 = new Car("BMW","X1", 32000.00);
...
class Dealership {
    ...
    public void addCar(Car carToAdd) {
        ...
        if (numCars < cars.length) {
            ...
            numCars++;
            System.out.println("Car added: " + carToAdd);
        } else {
